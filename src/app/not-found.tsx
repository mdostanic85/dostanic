    ...
    <main className="chapter-dark grain flex min-h-screen items-center bg-background px-5 pb-20 pt-28 text-foreground sm:px-8 lg:px-12">
      <div className="mx-auto grid w-full max-w-[1500px] grid-cols-1 gap-12 lg:grid-cols-12">
        <div className="lg:col-span-8">
          <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-accent">404 · Page not found</p>
        ...
        <div className="flex flex-col justify-end lg:col-span-4">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <Link href="/work" className="bg-foreground px-5 py-3 font-mono text-[10px] uppercase tracking-[0.2em] text-inverse-foreground hover:bg-accent hover:text-white">View work</Link>
            <Link href="/" className="border border-stroke px-5 py-3 font-mono text-[10px] uppercase tracking-[0.2em] text-muted hover:border-foreground hover:text-foreground">Home</Link>
          </div>
        </div>
      </div>
    </main>
