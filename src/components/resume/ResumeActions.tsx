  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      ...
      <button
        ...
        className="inline-flex h-11 items-center border border-[#111318]/20 px-5 font-mono text-[12px] uppercase tracking-[0.2em] text-[#111318]/70 transition-colors hover:border-[#111318] hover:text-[#111318]"
      >
        Print
      </button>
    </div>
