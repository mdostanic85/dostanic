...
export default function ProjectSignalCover({ project }: { project: Project }) {
  ...
  if (project.slug === 'worklight') {
    return (
      ...
      >
        <div className="flex items-center justify-between border-b border-white/15 pb-4 font-mono text-[11px] uppercase tracking-[0.2em] text-white/55">
        ...
        <div className="grid h-[calc(100%-2.5rem)] grid-cols-12 gap-3 pt-4 sm:gap-5">
          <div className="col-span-4 flex flex-col justify-between border border-white/10 p-3 sm:p-4">
            <span className="font-mono text-[10px] uppercase tracking-[0.18em] text-white/45">Read-only signals</span>
            <div className="space-y-2 font-mono text-[10px] uppercase tracking-[0.14em] text-white/70 sm:text-[11px]">
          ...
          <div className="col-span-8 flex flex-col justify-between bg-white/[0.055] p-4 sm:p-6">
            <div>
              <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-[#6c83ff]">Priority 01 · Confidence high</p>
            ...
            <div className="flex items-end justify-between gap-4 border-t border-white/10 pt-3">
              <p className="max-w-[30ch] text-[11px] leading-relaxed text-white/50 sm:text-xs">Why now, the next action, and the done criteria stay tied to source evidence.</p>
  ...
  return (
    ...
    >
      ...
      <div className="relative flex h-full flex-col justify-between">
        <div className="flex justify-between gap-4 font-mono text-[10px] uppercase tracking-[0.18em] text-white/50 sm:text-[11px] sm:tracking-[0.2em]">
        ...
        <div className="flex flex-wrap gap-x-5 gap-y-1 border-t border-white/15 pt-4 font-mono text-[10px] uppercase tracking-[0.14em] text-white/55 sm:grid sm:grid-cols-3 sm:text-[11px]">
